...
from wildfire_environment.core.constants import COLORS
...
class World:
    ...
    encode_dim: int
    normalize_obs: int
    OBJECT_TO_IDX: dict  # Map of object type to integers
    COLORS: dict  # Map of color names to RGB values
    COLOR_TO_IDX: dict = field(init=False)
    IDX_TO_COLOR: dict = field(init=False)
    IDX_TO_OBJECT: dict = field(init=False)
