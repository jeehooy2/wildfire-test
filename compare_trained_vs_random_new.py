...
실행 예시:
# 기본 실행 (기본 체크포인트 사용)
python compare_trained_vs_random_new.py --checkpoint ./rllib_checkpoints/best --episodes 10

# run1 실험 결과 비교 (best 모델)
python compare_trained_vs_random_new.py --checkpoint ./train_rllib/experiments/run1/best --episodes 10

# run2 실험 결과 비교 (final 모델)
python compare_trained_vs_random_new.py --checkpoint ./train_rllib/experiments/run2/final --episodes 10

# run1의 특정 체크포인트 비교
python compare_trained_vs_random_new.py --checkpoint ./train_rllib/experiments/run1/checkpoint_000100 --episodes 10
"""
