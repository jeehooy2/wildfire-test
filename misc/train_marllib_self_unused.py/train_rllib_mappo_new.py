...
from train_marllib_self.wildfire_rllib_wrapper import WildfireRLlibEnv
...
def train_rllib_multiagent(
    ...
    # 환경 설정 (train_marllib/environment.py의 ENV_CONFIG 사용)
    env_config = ENV_CONFIG

    # 환경 초기화(initialize)
    env = marl.make_env(environment_name="wildfire-ma", map_name="wildfire", abs_path="../../examples/config/env_config/wildfire-ma.yaml", **env_config)
